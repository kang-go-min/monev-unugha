...
class FillPermissionsForResponden extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForResponden constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.responden.show',
            'admin.responden.edit',
            'admin.responden.delete',
            'admin.responden.bulk-delete',
        ]);
